...
// Mock notification data for teachers
const mockNotifications = [
  {
    id: 1,
    type: "alert",
    title: "Pending Attendance",
    message: "You have 3 classes with unattended attendance today",
    time: "30 minutes ago",
    unread: true,
    icon: AlertCircle,
    color: "text-red-600",
  ...
  },
  {
    ...
    message: "CS Department meeting scheduled for tomorrow at 2 PM",
    time: "2 hours ago",
    unread: true,
    icon: Calendar,
    color: "text-sky-600",
  ...
  },
  {
    ...
    message: "You've graded 45 assignments for Database Systems",
    time: "5 hours ago",
    unread: false,
    icon: CheckCircle,
  ...
  },
  {
    ...
    message: "5 new students enrolled in your AI/ML class",
    time: "1 day ago",
    unread: false,
    icon: CheckCircle,
    color: "text-gray-600",
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3 group cursor-pointer hover:bg-gray-50 rounded-xl px-3 py-2 transition-all duration-200">
          <div className="text-right">
            ...
            <p className="text-xs text-gray-500 capitalize font-medium">Teacher</p>
          </div>
