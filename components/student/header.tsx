...
const mockNotifications = [
  ...
  },
  {
    ...
    message: "Tech Fest 2025 registration starts tomorrow",
    time: "5 hours ago",
    unread: true,
    icon: Calendar,
    color: "text-sky-600",
  ...
  },
  {
    ...
    message: "Your assignment for AI/ML has been submitted successfully",
    time: "1 day ago",
    unread: false,
    icon: CheckCircle,
  ...
  },
  {
    ...
    message: "Your mid-term exam grades are now available",
    time: "2 days ago",
    unread: false,
    icon: CheckCircle,
    color: "text-gray-600",
    ...
    <header className="h-16 border-b border-gray-200 bg-white flex items-center justify-between px-8 sticky top-0 z-40 shadow-sm">
      <div className="flex items-center flex-1 gap-6">
        <div className="relative flex-1 max-w-lg">
          ...
          <input
            type="text"
            placeholder="Search assignments, subjects, events..."
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3 group cursor-pointer hover:bg-gray-50 rounded-xl px-3 py-2 transition-all duration-200">
          <div className="text-right">
            ...
            <p className="text-xs text-gray-500 capitalize font-medium">Student</p>
          </div>
